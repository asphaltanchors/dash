...
- Each submodule has its own `AGENTS.md` with detailed component-specific guidance
...
- Each submodule has its own detailed `AGENTS.md` file
- Refer to `dashboard/AGENTS.md` for dashboard development details
